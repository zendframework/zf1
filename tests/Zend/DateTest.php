...
class Zend_DateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGet()
    {
        ...
        $this->assertSame('Freitag, 13. Februar 2009 um 23:31:30 UTC', $date->get(Zend_Date::DATETIME_FULL    ));
        $this->assertSame('13. Februar 2009 um 23:31:30 UTC', $date->get(Zend_Date::DATETIME_LONG    ));
        ...
        $this->assertSame(             '13 de feb. de 2009', $date->get(Zend_Date::DATES,             'es'));
        ...
        $this->assertSame(             '13 de feb. de 2009', $date->get(Zend_Date::DATE_MEDIUM,       'es'));
        ...
        $this->assertSame(    '13 de feb. de 2009 23:31:30', $date->get(Zend_Date::DATETIME,          'es'));
        ...
        $this->assertSame(    '13 de feb. de 2009 23:31:30', $date->get(Zend_Date::DATETIME_MEDIUM,   'es'));
        ...
        $this->assertSame('Samstag, 14. Februar 2009 um 04:31:30 Indian/Maldives', $date->get(Zend_Date::DATETIME_FULL    ));
        $this->assertSame(            '14. Februar 2009 um 04:31:30 MVT', $date->get(Zend_Date::DATETIME_LONG    ));
